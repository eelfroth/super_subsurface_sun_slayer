...
public class Underworld extends AbstractWorld{
    ...
    public Underworld(GameScreen gs) {
        super(GameScreen.setupShader( 
                Gdx.files.internal("com/BauhausGamesSyndicate/SSSS/shaders/under.vert").readString(),
                Gdx.files.internal("com/BauhausGamesSyndicate/SSSS/shaders/under.frag").readString()), 
                new Matrix4());
        
        this.texture = new Texture(Gdx.files.internal("com/BauhausGamesSyndicate/SSSS/assets/underworld.jpg"));
        ...
        buySound = Gdx.audio.newSound(Gdx.files.internal("com/BauhausGamesSyndicate/SSSS/assets/coin.wav"));
