...
import com.BauhausGamesSyndicate.SSSS.GameObjects.LightGod;
import com.BauhausGamesSyndicate.SSSS.GameObjects.Unicorn;
...
public class Overworld extends AbstractWorld{
    ...
    public Overworld() { 
        super(GameScreen.setupShader( 
                Gdx.files.internal("com/BauhausGamesSyndicate/SSSS/shaders/world.vert").readString(),
                Gdx.files.internal("com/BauhausGamesSyndicate/SSSS/shaders/world.frag").readString()), 
                new Matrix4());
