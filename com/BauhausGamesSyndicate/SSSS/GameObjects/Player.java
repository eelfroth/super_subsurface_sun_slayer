...
public class Player extends AbstractCharacter {
    ...
    public Player(float x, float y) {
        ...
        winscreen = new Texture(Gdx.files.internal("com/BauhausGamesSyndicate/SSSS/assets/gameoverwin.png"));
        losescreen = new Texture(Gdx.files.internal("com/BauhausGamesSyndicate/SSSS/assets/gameoverfail.png"));
        tohd = false;
