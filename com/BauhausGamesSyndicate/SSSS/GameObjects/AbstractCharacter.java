...
import com.BauhausGamesSyndicate.SSSS.overworld.Chunk;
...
public abstract class AbstractCharacter extends AbstractEntity {
    ...
    public AbstractCharacter(float x, float y, String name, boolean world, int steps, int specialSteps){
        ...
        if (dieSoundGood==null)
            dieSoundGood = Gdx.audio.newSound(Gdx.files.internal("com/BauhausGamesSyndicate/SSSS/assets/dieing.wav"));
        
        if (dieSoundEvil==null)
            dieSoundEvil = Gdx.audio.newSound(Gdx.files.internal("com/BauhausGamesSyndicate/SSSS/assets/splatter3.wav"));
