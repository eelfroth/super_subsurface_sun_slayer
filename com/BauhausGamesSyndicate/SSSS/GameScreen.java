...
public class GameScreen implements Screen {
    ...
    public GameScreen() {
        spritesheet = new TextureAtlas(Gdx.files.internal("com/BauhausGamesSyndicate/SSSS/assets/spritesheet.txt"));
        overlay = new Texture(Gdx.files.internal("com/BauhausGamesSyndicate/SSSS/assets/overlay.png"));
        debug_texture = new Texture(Gdx.files.internal("com/BauhausGamesSyndicate/SSSS/assets/mapping.png"));
        
        tutorial = new Sprite(new Texture(Gdx.files.internal("com/BauhausGamesSyndicate/SSSS/assets/tutorial.png")));
        tutorial.setX(541);
        tutorial.setY(300);
  ...
  //      debug_texture = new Texture(Gdx.files.internal("com/BauhausGamesSyndicate/SSSS/assets/gruppennfohto.jpg"));
        
        GameScreen.underworldMusic = Gdx.audio.newMusic(Gdx.files.internal("com/BauhausGamesSyndicate/SSSS/assets/underworldLoop.ogg"));
        underworldMusic.setLooping(true);
        underworldMusic.play();
        GameScreen.overworldMusic = Gdx.audio.newMusic(Gdx.files.internal("com/BauhausGamesSyndicate/SSSS/assets/overworldLoop.ogg"));
